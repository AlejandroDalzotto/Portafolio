...
export default function DetailsProject({ id }) {
    ...
    return (
        <article>
            <div>
                <h2 className="text-center my-6 text-4xl font-bold text-slate-50">{project && project.name}</h2>
                <p className="text-center my-6 font-medium text-slate-50">{project && project.description}</p>
